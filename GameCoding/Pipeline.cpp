...
void Pipeline::Draw(uint32 vertexCount, uint32 startVertexLoation)
{
	_deviceContext->Draw(vertexCount, startVertexLoation);
}

void Pipeline::DrawIndexed(uint32 indexCount, uint32 startIndexLoation, uint32 baseVertexLocation)
{
	_deviceContext->DrawIndexed(indexCount, startIndexLoation, baseVertexLocation);
}
